  ...
  Future _chooseDate(BuildContext context, String initialDateString) async {
    ...
    DatePicker.showDatePicker(context, showTitleActions: true,
        onConfirm: (date) {
          setState(() {
            DateTime dt = date;
            String r = DateUtils.ftDateAsString(dt);
...
// Upper Menu
  ...
  Widget build(BuildContext context){
    ...
    const String NumberOfDays = "Enter a number of days";
        ...
        child: SafeArea(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              Row(children: <Widget>[
                Expanded(child: Text('a: Alert 1.5 &1 years(s)')),
                Switch(
              ...
              Row(children: <Widget>[
                Expanded(child: Text('c: Alert @ 6 months')),
                Switch(value: fqHalfYearCtrl, onChanged: (bool value){
                  setState(() {
              ...
              Row(children: <Widget>[
                ...
                Switch(value: fqQuarterCtrl, onChanged: (bool value){
                  setState(() {
                    fqQuarterCtrl = value;
                  });
                })
              ...
              Row(children: <Widget>[
                ...
                Switch(value: fqMonthCtrl, onChanged: (bool value){
                  setState(() {
                    fqMonthCtrl = value;
                  });
                })
